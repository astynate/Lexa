...
class LexaTokenizer:
    ...
    def __init__(self, path: str, **kwargs) -> None:
        ...
        if os.path.exists(path):
            self.tokenizer = tfds.deprecated.text.SubwordTextEncoder.load_from_file(path)
        else:
            ...
            if dataset is not None:
                ...
                self.tokenizer.save_to_file(path)
            else:
...
if __name__ == '__main__':
    ...
    model_path: str = 'D:/Exider Company/Lexa/Lexa AI/Assistant/models/lexa_tokenizer'
